...
import com.tamerlanchik.robocar.usb.SerialModule;

public class ControlActivity extends AppCompatActivity implements ServiceConnection, SerialListener {
...
//        mSerial.setVB(this);
        ...
        g.setOnJoystickChangeListener(new Joystick.OnJoystickChangeListener() {
            ...
            public void onValueChanged(Joystick g, Point value) {
                ...
                send(MessageManager.buildJoystickMessage(value).toString());
